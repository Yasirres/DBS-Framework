...
Read the [platform adapter](references/platforms/codex.md) when deploying here.
Follow applicable AGENTS.md instructions and workspace conventions. Verify runtimes and preserve unrelated edits.
