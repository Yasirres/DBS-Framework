...
Read the [platform adapter](references/platforms/chatgpt.md) when deploying here.
For custom GPTs, place behavior in Instructions and references in Knowledge. In chat, explicitly supply the instructions. A Markdown file is not an automatic installation.
